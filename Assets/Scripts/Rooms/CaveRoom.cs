...
public class CaveRoom {
    ...
    public void SetupRoom(int roomColumns, int roomRows, int roomSmoothness, float roomWallQuant)
    {
        columns = roomColumns;
        rows = roomRows;
    ...
    void GenerateRoomFromCaves()
    {
        Debug.Log("Sala tipo Caverna: Escolhendo sala da caverna...");
